...
public class TitleDeedCards {
    ...
    private void initializeCards() {
        ...
        properties.put("Reading Railroad", new RailroadSpace("Reading Railroad", "Buy Property, Pay Rent, Mortgage", 200, rentPrice, ColorGroup.RAILROAD, 100));
        setRailroadRentPrices(rentPrice);
        properties.put("Pennsylvania Railroad", new RailroadSpace("Pennsylvania Railroad", "Buy Property, Pay Rent, Mortgage", 200, rentPrice, ColorGroup.RAILROAD, 100));
        setRailroadRentPrices(rentPrice);
        properties.put("B&O Railroad", new RailroadSpace("B&O Railroad", "Buy Property, Pay Rent, Mortgage", 200, rentPrice, ColorGroup.RAILROAD, 100));
        setRailroadRentPrices(rentPrice);
        properties.put("Short Line Railroad", new RailroadSpace("Short Line Railroad", "Buy Property, Pay Rent, Mortgage", 200, rentPrice, ColorGroup.RAILROAD, 100));

        setUtilitiesRentPriceMultiplier(rentPrice);
        properties.put("Electric Company", new ElectricCompanySpace("Buy Property, Pay Rent, Mortgage", 150, rentPrice, ColorGroup.UTILITY, 75));
        setUtilitiesRentPriceMultiplier(rentPrice);
        properties.put("Water Works", new WaterWorksSpace("Buy Property, Pay Rent, Mortgage", 150, rentPrice, ColorGroup.UTILITY, 75));
    }
